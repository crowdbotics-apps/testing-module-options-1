...
## Project Structure
    ...
    ├── testing_module_options_1  # Django project configurations
...
1. Clone this repo and `cd testing_module_options_1`
...
2. Clone this repo and `cd testing_module_options_1`
